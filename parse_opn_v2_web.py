"""
AM62x OPN Parser v2 - interactive web UI backed by master.csv.
...
Usage:
    python3 parse_opn_v2_web.py          (default port 8080)
    python3 parse_opn_v2_web.py 5000     (custom port)
"""
...
from parse_opn_v2 import (
    load_master,
    ORDERABLE_COLS, FEATURE_COLS, SPEED_COLS,
)
from parse_opn_html import CSS
